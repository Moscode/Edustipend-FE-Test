...
function App() {
  ...
  return (
    <div className='p-4 h-screen'>
      ...
      <div className='w-[100%] mx-auto text-center md:text-left py-4 md:py-8'>
        ...
        <Button content="Create playlist" style="bg-[#ff9900] rounded px-[1.2rem] md:px-[1.5rem] py-[0.3rem] md:py-[1rem] font-medium"/>
      </div>
      {/*Trend Songs Section*/}
      <div className='bg-[#666666] md:w-[25rem] h-[100%]'>
        <div className='flex flex-col items- py-4 items-center px-8 h-[100%] gap-y-6 md:py-8'>
        ...
        <TrendSongs content="Unavailable by Davido"/>
        <TrendSongs content="Unavailable by Davido"/>
        <Button content="View more" style="bg-[#ff9900] rounded px-[1.2rem] py-[0.3rem] md:py-[1rem] md:px-[1.5rem] font-medium"/>
      </div>
      </div>
      </div>
    </div>
